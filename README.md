...
| 平台 | 当前版本 | 安装包 |
| --- | --- | --- |
| Apple Silicon Mac | v0.10.2 | [下载 ZIP](https://github.com/qe1233/LinkNear-Releases/releases/download/v0.10.2/LinkNear-v0.10.2-macos-arm64.zip) |
...
| Android ARM64 | v0.10.2 | [下载 APK](https://github.com/qe1233/LinkNear-Releases/releases/download/v0.10.2/LinkNear-android-arm64.apk) |
...
- Android APK 使用固定发布证书。后续覆盖升级由系统核对签名；[公开证书指纹](https://github.com/qe1233/LinkNear-Releases/releases/download/v0.10.2/android-signing-certificate.sha256)随安装包发布。
